...
public interface DriverMapper {
    ...
    List<Driver> selectByParams(@Param("driverName") String driverName, @Param("phoneNum") String phoneNum, @Param("driverStatus") Integer driverStatus, @Param("coModelType") Integer coModelType, @Param("orderBy") String orderBy);
}